...
func ParticipantByUserID(w http.ResponseWriter, r *http.Request) {
	...
	res, err := server.MongoDB.Organization.New().Filter(filtersOrg).Participants().
	...
	httpkit.Render(w, responses.Participant(res[0]))
}
